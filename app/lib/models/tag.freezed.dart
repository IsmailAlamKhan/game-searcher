...
@override
String toString() {
  return 'Tag(id: $id, name: $name, slug: $slug, gamesCount: $gamesCount, imageBackground: $imageBackground)';
}
...
class _Tag implements Tag {
  const _Tag({required this.id, required this.name, required this.slug, @JsonKey(name: 'games_count') required this.gamesCount, @JsonKey(name: 'image_background') this.imageBackground});
