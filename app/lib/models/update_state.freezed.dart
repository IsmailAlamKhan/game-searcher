...
mixin _$UpdateState {
 ...
 UpdateStatus get status; double get downloadProgress; String? get errorMessage; String? get availableVersion;
...
bool operator ==(Object other) {
  return identical(this, other) || (other.runtimeType == runtimeType&&other is UpdateState&&(identical(other.status, status) || other.status == status)&&(identical(other.downloadProgress, downloadProgress) || other.downloadProgress == downloadProgress)&&(identical(other.errorMessage, errorMessage) || other.errorMessage == errorMessage)&&(identical(other.availableVersion, availableVersion) || other.availableVersion == availableVersion));
}


@override
int get hashCode => Object.hash(runtimeType,status,downloadProgress,errorMessage,availableVersion);

@override
String toString() {
  return 'UpdateState(status: $status, downloadProgress: $downloadProgress, errorMessage: $errorMessage, availableVersion: $availableVersion)';
}
...
@useResult
$Res call({
 UpdateStatus status, double downloadProgress, String? errorMessage, String? availableVersion
});
...
/// Create a copy of UpdateState
/// with the given fields replaced by the non-null parameter values.
@pragma('vm:prefer-inline') @override $Res call({Object? status = null,Object? downloadProgress = null,Object? errorMessage = freezed,Object? availableVersion = freezed,}) {
  return _then(_self.copyWith(
status: null == status ? _self.status : status // ignore: cast_nullable_to_non_nullable
as UpdateStatus,downloadProgress: null == downloadProgress ? _self.downloadProgress : downloadProgress // ignore: cast_nullable_to_non_nullable
as double,errorMessage: freezed == errorMessage ? _self.errorMessage : errorMessage // ignore: cast_nullable_to_non_nullable
as String?,availableVersion: freezed == availableVersion ? _self.availableVersion : availableVersion // ignore: cast_nullable_to_non_nullable
as String?,
  ));
}
...
@optionalTypeArgs TResult maybeWhen<TResult extends Object?>(TResult Function( UpdateStatus status,  double downloadProgress,  String? errorMessage,  String? availableVersion)?  $default,{required TResult orElse(),}) {final _that = this;
switch (_that) {
case _UpdateState() when $default != null:
return $default(_that.status,_that.downloadProgress,_that.errorMessage,_that.availableVersion);case _:
  return orElse();
...
@optionalTypeArgs TResult when<TResult extends Object?>(TResult Function( UpdateStatus status,  double downloadProgress,  String? errorMessage,  String? availableVersion)  $default,) {final _that = this;
switch (_that) {
case _UpdateState():
return $default(_that.status,_that.downloadProgress,_that.errorMessage,_that.availableVersion);case _:
  throw StateError('Unexpected subclass');
...
@optionalTypeArgs TResult? whenOrNull<TResult extends Object?>(TResult? Function( UpdateStatus status,  double downloadProgress,  String? errorMessage,  String? availableVersion)?  $default,) {final _that = this;
switch (_that) {
case _UpdateState() when $default != null:
return $default(_that.status,_that.downloadProgress,_that.errorMessage,_that.availableVersion);case _:
  return null;
...
class _UpdateState implements UpdateState {
  const _UpdateState({this.status = UpdateStatus.idle, this.downloadProgress = 0.0, this.errorMessage, this.availableVersion});
...
/// Create a copy of UpdateState
/// with the given fields replaced by the non-null parameter values.
@override @pragma('vm:prefer-inline') $Res call({Object? status = null,Object? downloadProgress = null,Object? errorMessage = freezed,Object? availableVersion = freezed,}) {
